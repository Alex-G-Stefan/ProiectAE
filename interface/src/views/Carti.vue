    ...
    <div class="container .cont">
      <div class="col" id="main">
               <div class="row .segment">
                  <Produs v-for="item in produse" :key="item.id" :id="item.id" :numeAutor="item.autor" :nume="item.nume" :numarPagini="item.numarPagini" :pret="item.pret" :link="item.link"></Produs>
               </div>
        </div>
    </div>
